...
BLOG_AUTHOR = "John Coughlan"  # (translatable)
BLOG_TITLE = "Another Data Blog"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://johncoughlan.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://johncoughlan.github.io/"
BLOG_EMAIL = "john.a.coughlan@gmail.com"
BLOG_DESCRIPTION = "Data-related thoughts and code that seem worth sharing (in no particular order)"  # (translatable)
